...
namespace NuciCraft.API.Service.Mapping
{
    ...
    internal static class PlayerMappingExtensions
    {
        ...
        internal static Player ToDomainModel(this PlayerDataObject dataObject) => new()
        {
            ...
            Gender = Gender.FromString(dataObject.Gender),
            ...
            BannedReason = dataObject.BannedReason,
            BannedBy = dataObject.BannedBy,
            IsMuted = dataObject.IsMuted,
            MutedDT = ParseNullableTimestamp(dataObject.MutedDT),
            MutedReason = dataObject.MutedReason,
            MutedBy = dataObject.MutedBy,
            ...
            LastSleptLocation = dataObject.LastSleptLocation?.ToServiceModel(),
        ...
        internal static PlayerDataObject ToDataObject(this Player domainModel) => new()
        {
            ...
            Gender = domainModel.Gender?.ExternalName,
            ...
            BannedReason = domainModel.BannedReason,
            BannedBy = domainModel.BannedBy,
            IsMuted = domainModel.IsMuted,
            MutedDT = domainModel.MutedDT?.ToString(TimestampFormats.Full, CultureInfo.InvariantCulture),
            MutedReason = domainModel.MutedReason,
            MutedBy = domainModel.MutedBy,
            ...
            LastSleptLocation = domainModel.LastSleptLocation?.ToDataObject(),
